...
var makeInfo = '<div class="d-flex justify-content-between align-items-center"><small class="text-muted">'+'shot in '+where+'<br/>'+'<br/>'+iso+'  '+f_number+'  '+ss+'</small></div>'
var makeBody = '<div class="card-body" style="background-color:#fafafa;">'+makeText+makeInfo+'</div>'
